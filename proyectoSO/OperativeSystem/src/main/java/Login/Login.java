...
public class Login {
   ...
   public static boolean esUsuario(String nombre, String contraseña){
        ManejadorArchivosGenerico manejador = new ManejadorArchivosGenerico();
        String[] usuarios = manejador.leerArchivoCoded("src\\usuarios.txt");     // Guardo usuarios y contraseñas en array de strings. Usuarios están en txt llamado usuarios en la carpeta src, un usuario:contraseña por linea
    ...
    public static void agregarUsuario(String nombre, String contraseña){
        ...
        manejador.escribirArchivoCoded("src\\usuarios.txt", usuarios);    // Escribo el txt "usuarios" en la carpeta src del proyecto con el usuario nuevo
    }   
